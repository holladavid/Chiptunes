...
c64: `
   ...
   amiga: `
        ...
        <div style="border-left: 4px solid var(--text-color); padding: 10px 15px; margin-bottom: 15px; background: rgba(0,0,0,0.2); line-height: 1.6;">
            ...
            <h4 style="color: var(--highlight-color); margin: 25px 0 5px 0;">> DIE VARIABLE D/A-WANDLUNGSRATE (DER AMIGA-SCHIMMER)</h4>
            ...
            <h4 style="color: var(--highlight-color); margin: 25px 0 5px 0;">> BIT-GENAUE DAC-MULTIPLIKATION</h4>
            ...
            <h4 style="color: var(--highlight-color); margin: 25px 0 5px 0;">> STATISCHER ANALOG-FILTER (6 dB/oct)</h4>
            ...
            <h4 style="color: var(--highlight-color); margin: 25px 0 5px 0;">> DYNAMISCHER LED-FILTER (12 dB/oct)</h4>
